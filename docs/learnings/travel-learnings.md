...
- **Bot detection**: none
- **Screenshot**: /tmp/open-cu-travel-learner-1274924/cabo_flights.png
...
- **Bot detection**: none
- **Screenshot**: /tmp/open-cu-travel-learner-1274580/cabo_flights.png

# Travel Scraping Learnings

Auto-generated learnings from the open-cu-travel-automation cron job.
Each entry captures what worked, what failed, and how to improve.

---

**Setup completed:**
- ✅ open-computer-use cloned and installed from Gitea
- ✅ open-cu-browser v0.1.21 installed (needs Chrome — not available on RPi)
...
- open-cu-browser requires Chrome which isn't installed (apt install times out)
- Hermes `browser_navigate()` + `browser_snapshot()` bypasses bot detection on Google Flights
- open-computer-use MCP server installed for desktop automation (not directly used for web scraping)
...
2. Test open-cu-browser with Chrome once available
