...
from open_computer_use.server import error_result, handle_request, json_dumps, ok_text, pretty_json
from open_computer_use.types import ELEMENT_CACHE, CachedElement, clear_cache, element_from_index, frame_center
...
class TestTypesModule:
    ...
    def test_flat_elements(self):
        from open_computer_use.types import flat_elements
...
class TestInputUtils:
    def test_normalize_button_valid(self):
        from open_computer_use.backends.input_utils import normalize_button
...
class TestLinuxKeyNormalization:
    def test_normalize_key_token_basic(self):
        from open_computer_use.backends.linux_x11 import normalize_key_token
    ...
    def test_press_key_sequence_empty_raises(self):
        from open_computer_use.backends.linux_x11 import _press_key_sequence
        with patch("open_computer_use.backends.linux_x11.require_pyautogui", return_value=MagicMock()), \
    ...
    def test_press_key_sequence_single(self):
        from open_computer_use.backends.linux_x11 import _press_key_sequence
        mock_pag = MagicMock()
        with patch("open_computer_use.backends.linux_x11.require_pyautogui", return_value=mock_pag):
...
class TestLinuxScrollDirections:
    def test_scroll_up(self):
        ...
        mock_pag = MagicMock()
        from open_computer_use.backends import input_utils, linux_x11
